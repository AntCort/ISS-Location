...
def get_user_position():
    print("If you don't know your coordinates, please visit this website: https://www.latlong.net/ \n")
...
def main():
    ...
    print(f'The ISS is currently located over Latitude: {iss_latitude} and Longitude: {iss_longitude}')
    ...
    folium.PolyLine(
        locations=((iss_position), (user_position)),
        color='green',
        weight=2
    ).add_to(m)
